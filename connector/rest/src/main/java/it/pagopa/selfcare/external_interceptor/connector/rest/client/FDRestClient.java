...
@FeignClient(name = "${rest-client.prod-fd.serviceCode}", url = "${rest-client.prod-fd.base-url}", configuration = {FDAuthorizationInterceptor.class, FDRestClientConfig.class})
