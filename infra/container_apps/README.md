...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_app_ext_interceptor"></a> [container\_app\_ext\_interceptor](#module\_container\_app\_ext\_interceptor) | github.com/pagopa/selfcare-commons//infra/terraform-modules/container_app_microservice | main |
